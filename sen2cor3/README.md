# Sen2Cor 3 version 3.03.02

## Retrieve Sen2cor 3.03.02 documentation and software:
...
## Unzip sen2cor_3.3.2_python_3.12.zip into the Sen2Cor 3 directory of your choice

```
e.g. sen2cor3_install_dir=/opt/sen2cor3/code/
cd $sen2cor3_install_dir
unzip sen2cor_3.3.2_python_3.12.zip
```
...
```
cd $sen2cor3_install_dir/sen2cor_3.3.2_python_3.12/SEN2COR_3/aux_data
...
```
cd $sen2cor3_install_dir/sen2cor_3.3.2_python_3.12
...
```
python $sen2cor3_install_dir/sen2cor_3.3.2_python_3.12/SEN2COR_3/L2A_Process.py --help
...
Sen2Cor. Version: 03.03.02, created: 2026.04.27, supporting Level-1C product version 15.1, supporting Level-1TP Collection_1-2 Landsat_8-9, supporting Hyper MS Level-1C.
...
options:
  ...
  --resolution {10,20,30,60}
                        Target resolution, can be 10, 20 or 60m for S2, 30m
                        for Hyper. If omitted, only 20 and 10m resolutions
                        will be processed
  --datastrip DATASTRIP
                        Datastrip folder
