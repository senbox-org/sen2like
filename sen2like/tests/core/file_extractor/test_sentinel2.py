...
class TestSentinel2Reader(AbstractExtractorTestCase):
    ...
    def test_s2_l1c(self):
        """test S2 L1C"""
        image_masks = self._verify(
            "31TFJ/S2A_MSIL1C_20171030T104151_N0500_R008_T31TFJ_20231014T203907.SAFE",
    ...
    def test_s2_l2a(self):
        """test S2 LA2"""
        self._verify(
            "31TFJ/S2A_MSIL2A_20171030T104151_N9999_R008_T31TFJ_20200519T152631.SAFE",
